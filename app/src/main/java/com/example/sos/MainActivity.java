...
//
//    Log.d("DB_COUNT", "Contacts: " + contactList);
//
//    if (contactList == 0) {
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel =
                    new NotificationChannel("MID", "CHANNEL FOREGROUND",
    ...
    private void updateStatusCard() {
        ...
        int colorPrimaryContainer =
                ContextCompat.getColor(this, colorPrimaryContainerValue.resourceId);
        ...
        int colorOnPrimaryContainer =
                ContextCompat.getColor(this, colorOnPrimaryContainerValue.resourceId);

        TypedValue colorSurfaceVariantValue = new TypedValue();
        getTheme().resolveAttribute(com.google.android.material.R.attr.colorSurfaceVariant,
                colorSurfaceVariantValue, true);
        int colorSurfaceVariant =
                ContextCompat.getColor(this, colorSurfaceVariantValue.resourceId);
        ...
        int colorOnSurfaceVariant =
                ContextCompat.getColor(this, colorOnSurfaceVariantValue.resourceId);

        TypedValue strokeColorValue = new TypedValue();
        getTheme().resolveAttribute(com.google.android.material.R.attr.colorOutline,
                strokeColorValue, true);
        int strokeColor =
                ContextCompat.getColor(this, strokeColorValue.resourceId);
